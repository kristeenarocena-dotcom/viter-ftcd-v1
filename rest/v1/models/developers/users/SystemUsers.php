...
class SystemUsers
{
    ...
    public function create()
    {
        try {
            ...
            $sql .= " sysuser_password, sysuser_key,";
            ...
            $query->execute([
                ...
                "sysuser_password"  => $this->sysuser_password,
                "sysuser_key"       => $this->sysuser_key,
    ...
    public function readKey()
    {
        try {
            ...
            $sql .= " where sysuser_key = :sysuser_key";
            $query = $this->connection->prepare($sql);
            $query->execute(["sysuser_key" => $this->sysuser_key]);
        } catch (PDOException $e) {
            $query = false;
        }
        return $query;
    ...
    public function setPassword()
    {
        try {
            $sql  = "update {$this->tblSystemUsers} set";
            $sql .= " sysuser_key = '',";
            $sql .= " sysuser_password = :sysuser_password,";
            $sql .= " sysuser_updated  = :sysuser_updated";
            $sql .= " where sysuser_key = :sysuser_key";
            $query = $this->connection->prepare($sql);
            $query->execute([
